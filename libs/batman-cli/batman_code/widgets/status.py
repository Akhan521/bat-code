"""Status bar widget for bat-code."""
...
from batman_code.config import settings
...
class StatusBar(Horizontal):
    """Status bar showing mode (THE CAVE / BATCOMPUTER), DETECTIVE / DARK
    KNIGHT MODE auto-approve indicator, and working directory."""
    ...
    def compose(self) -> ComposeResult:
        ...
        yield Static(
            "DETECTIVE MODE | shift+tab to cycle",
    ...
    def watch_mode(self, mode: str) -> None:
        ...
        if mode == "bash":
            indicator.update("THE CAVE")
            indicator.add_class("bash")
        elif mode == "command":
            indicator.update("BATCOMPUTER")
    ...
    def watch_auto_approve(self, new_value: bool) -> None:
        ...
        if new_value:
            indicator.update("DARK KNIGHT MODE | shift+tab to cycle")
            indicator.add_class("on")
        else:
            indicator.update("DETECTIVE MODE | shift+tab to cycle")
