...
DEFAULT_CONFIG_DIR = Path.home() / ".bat-code"
"""Directory for user-level bat-code configuration (`~/.bat-code`)."""

DEFAULT_CONFIG_PATH = DEFAULT_CONFIG_DIR / "config.toml"
"""Path to the user's model configuration file (`~/.bat-code/config.toml`)."""
...
class ModelConfig:
    ...
    def load(cls, config_path: Path | None = None) -> ModelConfig:
        ...
        Args:
            config_path: Path to config file. Defaults to ~/.bat-code/config.toml.
