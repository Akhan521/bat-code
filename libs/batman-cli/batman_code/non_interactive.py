"""Non-interactive execution mode for bat-code CLI.
...
from batman_code.file_ops import FileOpTracker
from batman_code.model_config import ModelConfigError
from batman_code.sessions import generate_thread_id, get_checkpointer
...
async def run_non_interactive(
    ...
    *,
    ...
    if sandbox_type != "none":
        from batman_code.integrations.sandbox_factory import (  # noqa: PLC0415
            create_sandbox,
        )
