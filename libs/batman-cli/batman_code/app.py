...
from batman_code.agent import create_batman_agent
from batman_code.clipboard import copy_selection_to_clipboard
...
from batman_code.widgets.model_selector import ModelSelectorScreen
from batman_code.widgets.status import StatusBar
from batman_code.widgets.thread_selector import ThreadSelectorScreen
...
_COMMAND_URLS: dict[str, str] = {
    "/changelog": "https://github.com/Akhan521/bat-code/blob/main/CHANGELOG.md",
    "/docs": DOCS_URL,
    "/feedback": "https://github.com/Akhan521/bat-code/issues/new/choose",
}
...
class BatmanApp(App):
    ...
    async def _switch_model(self, model_spec: str) -> None:
        ...
        # create_batman_agent because it builds the system prompt from global
        ...
        try:
            new_agent, new_backend = create_batman_agent(
                model=result.model,
