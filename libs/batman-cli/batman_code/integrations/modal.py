...
from batman_code.integrations.sandbox_provider import (
    SandboxProvider,
)
...
class ModalProvider(SandboxProvider):
    ...
    def __init__(self, app_name: str = "bat-code-sandbox") -> None:
        """Initialize Modal provider.

        Args:
            app_name: Name for the Modal app (default: "bat-code-sandbox")
        """
        import modal
