...
from batman_code.config import COLORS, console
...
async def list_threads_command(
    ...
    """CLI handler for `bat-code threads list`.
    ...
    if not threads:
        ...
        console.print("[dim]Start a conversation with: bat-code[/dim]")
        return
...
async def delete_thread_command(thread_id: str) -> None:
    """CLI handler for: bat-code threads delete."""
