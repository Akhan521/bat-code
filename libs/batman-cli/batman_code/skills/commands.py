...
- bat-code skills list --agent <agent> [--project]
- bat-code skills create <name>
- bat-code skills info <name>
"""
...
def _list(agent: str, *, project: bool = False) -> None:
    ...
    if project:
        ...
        has_batcode_skills = project_skills_dir.exists() and any(
        ...
        if not has_batcode_skills and not has_agent_skills:
            ...
            console.print(
                ...
                "  bat-code skills create my-skill --project[/dim]",
                style=COLORS["dim"],
            )
            return
...
# license: Apache-2.0
# compatibility: Designed for bat-code CLI
# metadata:
#   author: your-org
#   version: "1.0"
...
def _create(skill_name: str, agent: str, project: bool = False) -> None:
    ...
    console.print(
        ...
        f"  nano {skill_md}\n"
        "\n"
        "  See examples/skills/ in the bat-code repo for example skills:\n"
        "   - web-research: Structured research workflow\n"
        "   - langgraph-docs: LangGraph documentation lookup\n"
        "\n"
        "   Copy an example:\n"
        "   cp -r examples/skills/web-research ~/.bat-code/agent/skills/\n",
        style=COLORS["dim"],
    )
    ...
    *,
    ...
    create_parser = skills_subparsers.add_parser(
        ...
        description=(
            ...
            "~/.bat-code/<agent>/skills/. "
            "Use --project to create in the project's "
            ".bat-code/skills/ directory."
        ),
        add_help=False,
