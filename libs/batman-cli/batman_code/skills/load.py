...
from batman_code._version import __version__ as _cli_version
...
def list_skills(
    *,
    ...
    1. `user_skills_dir` (`~/.bat-code/{agent}/skills/`)
    2. `user_agent_skills_dir` (`~/.agents/skills/`)
    3. `project_skills_dir` (`.bat-code/skills/`)
    ...
    Args:
        ...
        user_skills_dir: Path to `~/.bat-code/{agent}/skills/`.
        project_skills_dir: Path to `.bat-code/skills/`.
    ...
    # 1. User bat-code skills (~/.bat-code/{agent}/skills/)
    ...
    # 2. User agent skills (~/.agents/skills/) - overrides user bat-code
    ...
    # 3. Project bat-code skills (.bat-code/skills/)
